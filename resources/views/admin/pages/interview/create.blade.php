...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
            <form role="form-entrevistas" action="{{ route('interviews-store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="entTitulo">Título</label>
                        <input type="text" class="form-control" id="entTitulo" name="entTitulo" placeholder="Digite o título">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="entAutor" name="entAutor" placeholder="Digite o nome do autor">
                    </div>
                    <div class="form-group">
                        <label for="slug">Caminho</label>
                        <input type="text" class="form-control" id="slug" name="slug" placeholder="Digite o caminho que essa entrevista terá">
                    </div>
                    <div class="form-group">
                        <label>Tags</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="entImagem">Selecione um imagem para a capa.</label>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="entImgLegenda" name="entImgLegenda" placeholder="Adicione uma legenda para deficientes visuais poderem entender sua imagem">
                    </div>
                    ...
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="entPublicacao" name="entPublicacao" value="1">
                        <label class="form-check-label" for="entPublicacao">Deseja publicar?</label>
                    </div>
                </div>
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Cadastrar entrevista</button>
